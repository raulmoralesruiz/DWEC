...
export class AppComponent {
  /* variable que mostrará el nombre del héroe */
  heroFavName: string;

  /* método que recoje el nombre y lo aplica a la variable anterior */
  setName(query: string): void {
    this.heroFavName = query;
  }
